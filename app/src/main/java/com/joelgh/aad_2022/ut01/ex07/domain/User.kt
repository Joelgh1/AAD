package com.joelgh.aad_2022.ut01.ex07.domain

data class User(var id: String , val name: String, val username: String, val email: String, val address: Address, val phone: String, val website: String, val company: Company)
